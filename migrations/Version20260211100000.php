...
final class Version20260211100000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE client_seo_keyword ADD last_optimized_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD relevance_level VARCHAR(10) NOT NULL DEFAULT \'medium\'');
    }
